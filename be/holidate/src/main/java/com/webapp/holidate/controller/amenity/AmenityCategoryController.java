...
public class AmenityCategoryController {
  ...
  @PostMapping
  public ApiResponse<AmenityCategoryDetailsResponse> create(@RequestBody @Valid AmenityCategoryCreationRequest request) {
    AmenityCategoryDetailsResponse response = service.create(request);
