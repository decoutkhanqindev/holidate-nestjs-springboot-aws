...
public class RoomQueries {
  ...
  private static final String FIND_WITH_HOTEL_BASE =
  ...
  public static final String FIND_ALL_BY_HOTEL_ID_WITH_WITH_DETAILS =
    FIND_WITH_DETAILS_BASE + "WHERE r.hotel.id = :hotelId";

  public static final String FIND_ALL_BY_HOTEL_ID_WITH_FILTERS =
