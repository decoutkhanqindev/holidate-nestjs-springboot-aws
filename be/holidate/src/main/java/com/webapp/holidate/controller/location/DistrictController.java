...
import com.webapp.holidate.constants.db.query.location.DistrictEndpoints;
...
public class DistrictController {
  ...
  @PostMapping
   public ApiResponse<LocationResponse> create(@RequestBody @Valid DistrictCreationRequest request) {
