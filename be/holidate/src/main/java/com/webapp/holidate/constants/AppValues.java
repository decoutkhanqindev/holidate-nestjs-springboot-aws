...
public class AppValues {
  ...
  public static final String TOKEN_EXPIRATION_MILLIS = "${spring.jwt.token.expiration-millis}";
  public static final String TOKEN_COOKIE_NAME = "${spring.jwt.token.cookie-name}";
