...
public class AppValues {
  ...
  public static final String VERIFICATION_EXPIRATION_MINUTES = "${spring.otp.verification.expiration-minutes}";
  public static final String VERIFICATION_MAX_ATTEMPTS = "${spring.otp.verification.max-attempts}";
  public static final String VERIFICATION_BLOCK_TIME_MINUTES = "${spring.otp.verification.block-time-minutes}";
