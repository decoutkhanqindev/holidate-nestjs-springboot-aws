...
doc_id: "e62cfd7e-9fa5-4759-9af7-6df520aa2ddc"  # Source: curl_step_3 -> data.id (GET /accommodation/rooms/{ROOM_ID})
slug: "deluxe-twin-with-city-view-golden-hotel-nha-trang"  # Source: Generated from curl_step_3 -> data.name + hotel.name
...
last_updated: "2025-11-29T10:09:16.3996351Z"  # Source: curl_step_3 -> data.updatedAt (fallback to createdAt if null)
language: "vi"
...
# === ROOM CLASSIFICATION ===
room_id: "e62cfd7e-9fa5-4759-9af7-6df520aa2ddc"  # Source: curl_step_3 -> data.id
room_name: "Deluxe Twin With City View"  # Source: curl_step_3 -> data.name (Vietnamese, e.g., "Premier Deluxe Triple")
...
area_sqm: 33.0  # Source: curl_step_3 -> data.area
...
specs:
  area_sqm: 33.0  # Float, Ví dụ: 33.0
...
pricing:
  base_price_vnd: 500000.0  # Giá cơ bản
...
# Source: curl_step_3 -> data
base_price: 500000  # Source: curl_step_3 -> data.basePricePerNight (VNĐ/night, BASE price, not dynamic)
...
inventory_calendar:
  - date: "2025-11-29"  # ISO format: 2025-11-29
    ...
    price_vnd: 650000.0  # Giá thực tế cho ngày này
  ...
  - date: "2025-12-01"  # ISO format: 2025-11-29
    ...
    is_holiday: false  # Boolean
    price_vnd: 500000.0  # Giá thực tế cho ngày này
    available_rooms: 10  # Số phòng còn trống
    status: "available"  # "available", "limited", "sold_out"
  ...
  - date: "2025-12-12"  # ISO format: 2025-11-29
    ...
    is_weekend: false  # Boolean
    is_holiday: false  # Boolean
    price_vnd: 440000.0  # Giá thực tế cho ngày này
    available_rooms: 10  # Số phòng còn trống
    status: "available"  # "available", "limited", "sold_out"
  ...
  - date: "2025-12-25"  # ISO format: 2025-11-29
    ...
    is_weekend: false  # Boolean
    is_holiday: false  # Boolean
    price_vnd: 375000.0  # Giá thực tế cho ngày này
    available_rooms: 10  # Số phòng còn trống
    status: "available"  # "available", "limited", "sold_out"
...
price_analytics:
  min_price_next_30_days: 375000.0
  max_price_next_30_days: 650000.0
  avg_price_next_30_days: 542419.3548387097
...
# === SEO KEYWORDS ===
keywords:
  - "deluxe twin with city view"  # Generated from: room.name, city.name, view, bed_type, room_type
...
# 🛏️ Deluxe Twin With City View - **Deluxe Twin With City View** là hạng phòng hướng thành phố tại Golden Hotel Nha Trang, với diện tích 33.0m², phù hợp cho tối đa 2 người lớn.

![Deluxe Twin With City View](https://holidate-storage.s3.ap-southeast-1.amazonaws.com/10019241-2514x1699-FIT_AND_TRIM-b1fe75c115f7045ae38f6a9b9785ef62.jpeg)  # Source: curl_step_3 -> data.photos[].photos[0].url (first photo, or filter by category)
...
|-----------------------|------------------------------------------|
| **Diện tích**         | 33.0 m²                         |  # Source: curl_step_3 -> data.area
...
**Deluxe Twin With City View** là hạng phòng hướng thành phố tại Golden Hotel Nha Trang, với diện tích 33.0m², phù hợp cho tối đa 2 người lớn và 0 trẻ em.
...
|------|-----|-----------|------------|
| 2025-11-29 | saturday | 650000.0 | ✅ Còn 10 phòng |
| 2025-11-30 | sunday | 650000.0 | ✅ Còn 10 phòng |
