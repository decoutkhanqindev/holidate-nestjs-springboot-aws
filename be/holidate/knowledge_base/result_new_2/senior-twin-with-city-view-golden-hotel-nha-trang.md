...
doc_id: "42663b53-2c12-4aef-8af4-53ec43955bdd"  # Source: curl_step_3 -> data.id (GET /accommodation/rooms/{ROOM_ID})
slug: "senior-twin-with-city-view-golden-hotel-nha-trang"  # Source: Generated from curl_step_3 -> data.name + hotel.name
...
last_updated: "2025-11-29T10:09:14.8086339Z"  # Source: curl_step_3 -> data.updatedAt (fallback to createdAt if null)
language: "vi"
...
# === ROOM CLASSIFICATION ===
room_id: "42663b53-2c12-4aef-8af4-53ec43955bdd"  # Source: curl_step_3 -> data.id
room_name: "Senior Twin With City View"  # Source: curl_step_3 -> data.name (Vietnamese, e.g., "Premier Deluxe Triple")
...
# === SEO KEYWORDS ===
keywords:
  - "senior twin with city view"  # Generated from: room.name, city.name, view, bed_type, room_type
...
# 🛏️ Senior Twin With City View - **Senior Twin With City View** là hạng phòng hướng thành phố tại Golden Hotel Nha Trang, với diện tích 25.0m², phù hợp cho tối đa 2 người lớn.

![Senior Twin With City View](https://holidate-storage.s3.ap-southeast-1.amazonaws.com/087b6ed7_z.jpg)  # Source: curl_step_3 -> data.photos[].photos[0].url (first photo, or filter by category)
...
**Senior Twin With City View** là hạng phòng hướng thành phố tại Golden Hotel Nha Trang, với diện tích 25.0m², phù hợp cho tối đa 2 người lớn và 0 trẻ em.
...
>
> Phòng **Senior Twin With City View** có **giá cơ bản** là **500000 VNĐ/đêm**, nhưng giá thực tế bạn phải trả sẽ **thay đổi** tùy vào:
>
...
![Senior Twin With City View](https://holidate-storage.s3.ap-southeast-1.amazonaws.com/95fbe588_z.jpg)
  # Source: curl_step_3 -> data.photos[].photos[].url (all except main, limit 10)
![Senior Twin With City View](https://holidate-storage.s3.ap-southeast-1.amazonaws.com/3d8210a9_z.jpg)
