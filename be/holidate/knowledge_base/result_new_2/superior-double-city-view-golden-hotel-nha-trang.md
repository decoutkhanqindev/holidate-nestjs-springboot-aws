...
doc_id: "63c6891a-fd41-4342-99bb-6c7d561581af"  # Source: curl_step_3 -> data.id (GET /accommodation/rooms/{ROOM_ID})
slug: "superior-double-city-view-golden-hotel-nha-trang"  # Source: Generated from curl_step_3 -> data.name + hotel.name
...
last_updated: "2025-11-29T10:09:14.4906318Z"  # Source: curl_step_3 -> data.updatedAt (fallback to createdAt if null)
language: "vi"
...
# === ROOM CLASSIFICATION ===
room_id: "63c6891a-fd41-4342-99bb-6c7d561581af"  # Source: curl_step_3 -> data.id
room_name: "Superior Double City View"  # Source: curl_step_3 -> data.name (Vietnamese, e.g., "Premier Deluxe Triple")
room_type: "superior"  # INFERRED from curl_step_3 -> data.name using inferRoomType() logic
...
area_sqm: 18.0  # Source: curl_step_3 -> data.area
...
pricing:
  base_price_vnd: 400000.0  # Giá cơ bản
...
# Source: curl_step_3 -> data
base_price: 400000  # Source: curl_step_3 -> data.basePricePerNight (VNĐ/night, BASE price, not dynamic)
...
inventory_calendar:
  - date: "2025-11-29"  # ISO format: 2025-11-29
    ...
    price_vnd: 520000.0  # Giá thực tế cho ngày này
  ...
  - date: "2025-12-01"  # ISO format: 2025-11-29
    ...
    is_holiday: false  # Boolean
    price_vnd: 400000.0  # Giá thực tế cho ngày này
    available_rooms: 10  # Số phòng còn trống
    status: "available"  # "available", "limited", "sold_out"
  ...
  - date: "2025-12-12"  # ISO format: 2025-11-29
    ...
    is_weekend: false  # Boolean
    is_holiday: false  # Boolean
    price_vnd: 352000.0  # Giá thực tế cho ngày này
    available_rooms: 10  # Số phòng còn trống
    status: "available"  # "available", "limited", "sold_out"
  ...
  - date: "2025-12-25"  # ISO format: 2025-11-29
    ...
    is_weekend: false  # Boolean
    is_holiday: false  # Boolean
    price_vnd: 300000.0  # Giá thực tế cho ngày này
    available_rooms: 10  # Số phòng còn trống
    status: "available"  # "available", "limited", "sold_out"
...
price_analytics:
  min_price_next_30_days: 300000.0
  max_price_next_30_days: 520000.0
  avg_price_next_30_days: 433935.48387096776
...
# === SEO KEYWORDS ===
keywords:
  - "superior double city view"  # Generated from: room.name, city.name, view, bed_type, room_type
  - "phòng thành phố nha trang"  # Generated from: room.name, city.name, view, bed_type, room_type
  - "phòng superior"  # Generated from: room.name, city.name, view, bed_type, room_type

---

# 🛏️ Superior Double City View - **Superior Double City View** là hạng phòng hướng thành phố tại Golden Hotel Nha Trang, với diện tích 18.0m², phù hợp cho tối đa 2 người lớn.

![Superior Double City View](https://holidate-storage.s3.ap-southeast-1.amazonaws.com/10019241-800x518-FIT_AND_TRIM-519e495dd0a4b9e1c786d6cbf2bdb205.jpg)  # Source: curl_step_3 -> data.photos[].photos[0].url (first photo, or filter by category)
...
|-----------------------|------------------------------------------|
| **Diện tích**         | 18.0 m²                         |  # Source: curl_step_3 -> data.area
...
**Superior Double City View** là hạng phòng hướng thành phố tại Golden Hotel Nha Trang, với diện tích 18.0m², phù hợp cho tối đa 2 người lớn và 0 trẻ em.
...
|------|-----|-----------|------------|
| 2025-11-29 | saturday | 520000.0 | ✅ Còn 10 phòng |
| 2025-11-30 | sunday | 520000.0 | ✅ Còn 10 phòng |
| 2025-12-01 | monday | 400000.0 | ✅ Còn 10 phòng |
| 2025-12-02 | tuesday | 400000.0 | ✅ Còn 10 phòng |
| 2025-12-03 | wednesday | 400000.0 | ✅ Còn 10 phòng |
| 2025-12-04 | thursday | 400000.0 | ✅ Còn 10 phòng |
| 2025-12-05 | friday | 400000.0 | ✅ Còn 10 phòng |
...
|------|-----|---------------|-------------|-----------|
| 2025-11-29 | saturday | 520000.0 | 10 | 🌟 Cuối tuần |
| 2025-11-30 | sunday | 520000.0 | 10 | 🌟 Cuối tuần |
| 2025-12-01 | monday | 400000.0 | 10 | Ngày thường |
| 2025-12-02 | tuesday | 400000.0 | 10 | Ngày thường |
| 2025-12-03 | wednesday | 400000.0 | 10 | Ngày thường |
| 2025-12-04 | thursday | 400000.0 | 10 | Ngày thường |
| 2025-12-05 | friday | 400000.0 | 10 | Ngày thường |
| 2025-12-06 | saturday | 520000.0 | 10 | 🌟 Cuối tuần |
| 2025-12-07 | sunday | 520000.0 | 10 | 🌟 Cuối tuần |
| 2025-12-08 | monday | 400000.0 | 10 | Ngày thường |
| 2025-12-09 | tuesday | 400000.0 | 10 | Ngày thường |
| 2025-12-10 | wednesday | 400000.0 | 10 | Ngày thường |
| 2025-12-11 | thursday | 400000.0 | 10 | Ngày thường |
| 2025-12-12 | friday | 352000.0 | 10 | Ngày thường |
| 2025-12-13 | saturday | 520000.0 | 10 | 🌟 Cuối tuần |
| 2025-12-14 | sunday | 520000.0 | 10 | 🌟 Cuối tuần |
| 2025-12-15 | monday | 400000.0 | 10 | Ngày thường |
| 2025-12-16 | tuesday | 400000.0 | 10 | Ngày thường |
| 2025-12-17 | wednesday | 400000.0 | 10 | Ngày thường |
| 2025-12-18 | thursday | 400000.0 | 10 | Ngày thường |
| 2025-12-19 | friday | 400000.0 | 10 | Ngày thường |
| 2025-12-20 | saturday | 520000.0 | 10 | 🌟 Cuối tuần |
| 2025-12-21 | sunday | 520000.0 | 10 | 🌟 Cuối tuần |
| 2025-12-22 | monday | 400000.0 | 10 | Ngày thường |
| 2025-12-23 | tuesday | 400000.0 | 10 | Ngày thường |
| 2025-12-24 | wednesday | 400000.0 | 10 | Ngày thường |
| 2025-12-25 | thursday | 300000.0 | 10 | Ngày thường |
| 2025-12-26 | friday | 400000.0 | 10 | Ngày thường |
| 2025-12-27 | saturday | 520000.0 | 10 | 🌟 Cuối tuần |
| 2025-12-28 | sunday | 520000.0 | 10 | 🌟 Cuối tuần |
| 2025-12-29 | monday | 400000.0 | 10 | Ngày thường |
### 📆 Thông Tin Theo Ngày
| Ngày | Thứ | Giá (VNĐ/đêm) | Phòng Trống | Loại Ngày |
|------|-----|---------------|-------------|-----------|
| 2025-11-29 | saturday | 520000.0 | 10 | 🌟 Cuối tuần |
...
- **Giá thấp nhất**: 300000.0 VNĐ/đêm
- **Giá cao nhất**: 520000.0 VNĐ/đêm
- **Giá trung bình**: 433935.48387096776 VNĐ/đêm
...
>
> Phòng **Superior Double City View** có **giá cơ bản** là **400000 VNĐ/đêm**, nhưng giá thực tế bạn phải trả sẽ **thay đổi** tùy vào:
>
...
![Superior Double City View](https://holidate-storage.s3.ap-southeast-1.amazonaws.com/10019241-1827x1219-FIT_AND_TRIM-a36d9257b8ff3636c8ec151304d1293b.jpeg)
  # Source: curl_step_3 -> data.photos[].photos[].url (all except main, limit 10)
![Superior Double City View](https://holidate-storage.s3.ap-southeast-1.amazonaws.com/10019241-2514x1699-FIT_AND_TRIM-b1fe75c115f7045ae38f6a9b9785ef62.jpeg)
