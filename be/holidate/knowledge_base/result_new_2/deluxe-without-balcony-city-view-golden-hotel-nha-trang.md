...
doc_id: "2d708a42-898b-4866-8c78-f203db0949ca"  # Source: curl_step_3 -> data.id (GET /accommodation/rooms/{ROOM_ID})
slug: "deluxe-without-balcony-city-view-golden-hotel-nha-trang"  # Source: Generated from curl_step_3 -> data.name + hotel.name
...
last_updated: "2025-11-29T10:09:13.8246342Z"  # Source: curl_step_3 -> data.updatedAt (fallback to createdAt if null)
language: "vi"
...
# === ROOM CLASSIFICATION ===
room_id: "2d708a42-898b-4866-8c78-f203db0949ca"  # Source: curl_step_3 -> data.id
room_name: "Deluxe Without Balcony City View"  # Source: curl_step_3 -> data.name (Vietnamese, e.g., "Premier Deluxe Triple")
...
bed_type: "2 giường đơn"  # Source: curl_step_3 -> data.bedType.name (Vietnamese, e.g., "2 giường đơn")
bed_type_id: "78efbc97-a067-11f0-a7b7-0a6aab4924ab"  # Source: curl_step_3 -> data.bedType.id
max_adults: 2  # Source: curl_step_3 -> data.maxAdults
max_children: 0  # Source: curl_step_3 -> data.maxChildren
area_sqm: 32.0  # Source: curl_step_3 -> data.area
...
specs:
  area_sqm: 32.0  # Float, Ví dụ: 33.0
  has_balcony: false  # Boolean
  has_window: true  # Boolean
  view_type: "city"  # Enum: "ocean", "city", "mountain", "no_view"
  bed_configuration:
    - type: "single"  # Ví dụ: "single", "double", "king"
      count: 2  # Integer

# === GIÁ CẢ & TỒN KHO CHI TIẾT ===
pricing:
  base_price_vnd: 750000.0  # Giá cơ bản
...
room_amenity_tags:
  ...
  - "safe_box"  # Source: curl_step_3 -> data.amenities[].amenities[].name -> mapped to English (e.g., "microwave", "refrigerator", "air_conditioning")
  ...
  - "work_desk"  # Source: curl_step_3 -> data.amenities[].amenities[].name -> mapped to English (e.g., "microwave", "refrigerator", "air_conditioning")
...
# Source: curl_step_3 -> data
base_price: 750000  # Source: curl_step_3 -> data.basePricePerNight (VNĐ/night, BASE price, not dynamic)
...
inventory_calendar:
  - date: "2025-11-29"  # ISO format: 2025-11-29
    ...
    price_vnd: 975000.0  # Giá thực tế cho ngày này
  ...
  - date: "2025-12-01"  # ISO format: 2025-11-29
    ...
    is_holiday: false  # Boolean
    price_vnd: 750000.0  # Giá thực tế cho ngày này
    available_rooms: 8  # Số phòng còn trống
    status: "available"  # "available", "limited", "sold_out"
  ...
  - date: "2025-12-12"  # ISO format: 2025-11-29
    ...
    is_weekend: false  # Boolean
    is_holiday: false  # Boolean
    price_vnd: 660000.0  # Giá thực tế cho ngày này
    available_rooms: 10  # Số phòng còn trống
    status: "available"  # "available", "limited", "sold_out"
  ...
  - date: "2025-12-25"  # ISO format: 2025-11-29
    ...
    is_weekend: false  # Boolean
    is_holiday: false  # Boolean
    price_vnd: 562500.0  # Giá thực tế cho ngày này
    available_rooms: 10  # Số phòng còn trống
    status: "available"  # "available", "limited", "sold_out"
...
price_analytics:
  min_price_next_30_days: 562500.0
  max_price_next_30_days: 975000.0
  avg_price_next_30_days: 813629.0322580645
...
# === SEO KEYWORDS ===
keywords:
  - "deluxe without balcony city view"  # Generated from: room.name, city.name, view, bed_type, room_type
...
# 🛏️ Deluxe Without Balcony City View - **Deluxe Without Balcony City View** là hạng phòng hướng thành phố tại Golden Hotel Nha Trang, với diện tích 32.0m², phù hợp cho tối đa 2 người lớn.

![Deluxe Without Balcony City View](https://holidate-storage.s3.ap-southeast-1.amazonaws.com/0a26ecd8_z.jpg)  # Source: curl_step_3 -> data.photos[].photos[0].url (first photo, or filter by category)
...
|-----------------------|------------------------------------------|
| **Diện tích**         | 32.0 m²                         |  # Source: curl_step_3 -> data.area
| **Loại giường**       | 2 giường đơn                            |  # Source: curl_step_3 -> data.bedType.name
...
**Deluxe Without Balcony City View** là hạng phòng hướng thành phố tại Golden Hotel Nha Trang, với diện tích 32.0m², phù hợp cho tối đa 2 người lớn và 0 trẻ em.
...
|------|-----|-----------|------------|
| 2025-11-29 | saturday | 975000.0 | ✅ Còn 10 phòng |
| 2025-11-30 | sunday | 975000.0 | ✅ Còn 10 phòng |
| 2025-12-01 | monday | 750000.0 | ✅ Còn 8 phòng |
| 2025-12-02 | tuesday | 750000.0 | ✅ Còn 8 phòng |
| 2025-12-03 | wednesday | 750000.0 | ✅ Còn 10 phòng |
| 2025-12-04 | thursday | 750000.0 | ✅ Còn 10 phòng |
| 2025-12-05 | friday | 750000.0 | ✅ Còn 10 phòng |
...
|------|-----|---------------|-------------|-----------|
| 2025-11-29 | saturday | 975000.0 | 10 | 🌟 Cuối tuần |
| 2025-11-30 | sunday | 975000.0 | 10 | 🌟 Cuối tuần |
| 2025-12-01 | monday | 750000.0 | 8 | Ngày thường |
| 2025-12-02 | tuesday | 750000.0 | 8 | Ngày thường |
| 2025-12-03 | wednesday | 750000.0 | 10 | Ngày thường |
| 2025-12-04 | thursday | 750000.0 | 10 | Ngày thường |
| 2025-12-05 | friday | 750000.0 | 10 | Ngày thường |
| 2025-12-06 | saturday | 975000.0 | 10 | 🌟 Cuối tuần |
| 2025-12-07 | sunday | 975000.0 | 10 | 🌟 Cuối tuần |
| 2025-12-08 | monday | 750000.0 | 10 | Ngày thường |
| 2025-12-09 | tuesday | 750000.0 | 10 | Ngày thường |
| 2025-12-10 | wednesday | 750000.0 | 10 | Ngày thường |
| 2025-12-11 | thursday | 750000.0 | 10 | Ngày thường |
| 2025-12-12 | friday | 660000.0 | 10 | Ngày thường |
| 2025-12-13 | saturday | 975000.0 | 10 | 🌟 Cuối tuần |
| 2025-12-14 | sunday | 975000.0 | 10 | 🌟 Cuối tuần |
| 2025-12-15 | monday | 750000.0 | 10 | Ngày thường |
| 2025-12-16 | tuesday | 750000.0 | 10 | Ngày thường |
| 2025-12-17 | wednesday | 750000.0 | 10 | Ngày thường |
| 2025-12-18 | thursday | 750000.0 | 10 | Ngày thường |
| 2025-12-19 | friday | 750000.0 | 10 | Ngày thường |
| 2025-12-20 | saturday | 975000.0 | 10 | 🌟 Cuối tuần |
| 2025-12-21 | sunday | 975000.0 | 10 | 🌟 Cuối tuần |
| 2025-12-22 | monday | 750000.0 | 10 | Ngày thường |
| 2025-12-23 | tuesday | 750000.0 | 10 | Ngày thường |
| 2025-12-24 | wednesday | 750000.0 | 10 | Ngày thường |
| 2025-12-25 | thursday | 562500.0 | 10 | Ngày thường |
| 2025-12-26 | friday | 750000.0 | 10 | Ngày thường |
| 2025-12-27 | saturday | 975000.0 | 10 | 🌟 Cuối tuần |
| 2025-12-28 | sunday | 975000.0 | 10 | 🌟 Cuối tuần |
| 2025-12-29 | monday | 750000.0 | 10 | Ngày thường |
### 📆 Thông Tin Theo Ngày
| Ngày | Thứ | Giá (VNĐ/đêm) | Phòng Trống | Loại Ngày |
|------|-----|---------------|-------------|-----------|
| 2025-11-29 | saturday | 975000.0 | 10 | 🌟 Cuối tuần |
...
- **Giá thấp nhất**: 562500.0 VNĐ/đêm
- **Giá cao nhất**: 975000.0 VNĐ/đêm
- **Giá trung bình**: 813629.0322580645 VNĐ/đêm
...
- Ngày **2025-12-01**: ✅ Còn nhiều phòng (8 phòng)
- Ngày **2025-12-02**: ✅ Còn nhiều phòng (8 phòng)
...
>
> Phòng **Deluxe Without Balcony City View** có **giá cơ bản** là **750000 VNĐ/đêm**, nhưng giá thực tế bạn phải trả sẽ **thay đổi** tùy vào:
>
...
![Deluxe Without Balcony City View](https://holidate-storage.s3.ap-southeast-1.amazonaws.com/087b6ed7_z.jpg)
  # Source: curl_step_3 -> data.photos[].photos[].url (all except main, limit 10)
![Deluxe Without Balcony City View](https://holidate-storage.s3.ap-southeast-1.amazonaws.com/3d8210a9_z.jpg)
