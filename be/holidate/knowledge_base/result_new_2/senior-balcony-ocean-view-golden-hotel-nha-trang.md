...
doc_id: "1323d737-1893-4062-8b51-7d98fe6d52fc"  # Source: curl_step_3 -> data.id (GET /accommodation/rooms/{ROOM_ID})
slug: "senior-balcony-ocean-view-golden-hotel-nha-trang"  # Source: Generated from curl_step_3 -> data.name + hotel.name
...
last_updated: "2025-11-29T10:09:15.4366349Z"  # Source: curl_step_3 -> data.updatedAt (fallback to createdAt if null)
language: "vi"
...
# === ROOM CLASSIFICATION ===
room_id: "1323d737-1893-4062-8b51-7d98fe6d52fc"  # Source: curl_step_3 -> data.id
room_name: "Senior Balcony Ocean View"  # Source: curl_step_3 -> data.name (Vietnamese, e.g., "Premier Deluxe Triple")
...
room_amenity_tags:
  ...
  - "ao_choang_tam"  # Source: curl_step_3 -> data.amenities[].amenities[].name -> mapped to English (e.g., "microwave", "refrigerator", "air_conditioning")
...
smoking_allowed: true  # Source: curl_step_3 -> data.smokingAllowed
...
# === SEO KEYWORDS ===
keywords:
  - "senior balcony ocean view"  # Generated from: room.name, city.name, view, bed_type, room_type
...
# 🛏️ Senior Balcony Ocean View - **Senior Balcony Ocean View** là hạng phòng hướng biển tại Golden Hotel Nha Trang, với diện tích 25.0m², phù hợp cho tối đa 2 người lớn.

![Senior Balcony Ocean View](https://holidate-storage.s3.ap-southeast-1.amazonaws.com/0a26ecd8_z.jpg)  # Source: curl_step_3 -> data.photos[].photos[0].url (first photo, or filter by category)
...
**Senior Balcony Ocean View** là hạng phòng hướng biển tại Golden Hotel Nha Trang, với diện tích 25.0m², phù hợp cho tối đa 2 người lớn và 0 trẻ em.
...
| 2025-12-01 | monday | 750000.0 | ✅ Còn 10 phòng |
| 2025-12-02 | tuesday | 750000.0 | ✅ Còn 10 phòng |
...
| 2025-12-01 | monday | 750000.0 | 10 | Ngày thường |
| 2025-12-02 | tuesday | 750000.0 | 10 | Ngày thường |
...
>
> Phòng **Senior Balcony Ocean View** có **giá cơ bản** là **750000 VNĐ/đêm**, nhưng giá thực tế bạn phải trả sẽ **thay đổi** tùy vào:
>
...
![Senior Balcony Ocean View](https://holidate-storage.s3.ap-southeast-1.amazonaws.com/087b6ed7_z.jpg)
  # Source: curl_step_3 -> data.photos[].photos[].url (all except main, limit 10)
![Senior Balcony Ocean View](https://holidate-storage.s3.ap-southeast-1.amazonaws.com/3d8210a9_z.jpg)
