...
last_updated: "2025-11-29T03:37:56.7250215Z"  # Source: curl_step_3 -> data.updatedAt (fallback to createdAt if null)
language: "vi"
...
![Senior Balcony City View](https://holidate-storage.s3.ap-southeast-1.amazonaws.com/3d8210a9_z.jpg)  # Source: curl_step_3 -> data.photos[].photos[0].url (first photo, or filter by category)
