...
import {
    ...
    FaNewspaper, FaCreditCard, FaChartBar, FaFileContract, FaGlobe,
    FaTicketAlt, FaFileAlt, FaStar, FaCalendarDay
} from "react-icons/fa";

const superAdminMenu = [
    { href: "/super-admin", label: "Trang chủ", icon: FaHome },
    { href: "/super-reports", label: "Báo cáo", icon: FaFileAlt },
    { href: "/super-user-management", label: "Quản lý Đối tác Khách sạn", icon: FaUsersCog },
    { href: "/super-hotels", label: "Quản lý khách sạn", icon: FaBuilding },
    { href: "/super-users", label: "Quản lý người dùng", icon: FaUsers },
    ...
    { href: "/super-booking", label: "Quản lý đơn hàng", icon: FaNewspaper },
    { href: "/super-reviews", label: "Quản lý đánh giá", icon: FaStar },
    ...
    { href: "/super-special-days", label: "Quản lý ngày đặc biệt", icon: FaCalendarDay },
