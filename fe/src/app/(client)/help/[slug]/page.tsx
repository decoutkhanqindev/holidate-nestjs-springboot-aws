...
// Data mapping cho các trang help
const helpContent: Record<string, {
    ...
    'holidatepay': {
        title: 'HolidatePay - Thanh toán',
        content: [
            {
                heading: 'Giới thiệu HolidatePay',
                paragraphs: [
                    'HolidatePay là ví điện tử tích hợp trên nền tảng Holidate, giúp bạn thanh toán nhanh chóng và an toàn.',
                    'Lợi ích:',
                    '• Thanh toán chỉ với 1 cú click',
                    '• Tích lũy điểm thưởng khi thanh toán',
                    '• Hoàn tiền nhanh chóng khi hủy đặt phòng',
                    '• Bảo mật tuyệt đối với mã OTP'
                ]
            },
            {
                heading: 'Cách sử dụng',
                paragraphs: [
                    '1. Nạp tiền vào ví HolidatePay qua thẻ ngân hàng',
                    '2. Chọn HolidatePay khi thanh toán đặt phòng',
                    '3. Xác nhận thanh toán bằng mã OTP',
                    '4. Hoàn tất!',
                    'Bạn cũng có thể rút tiền từ ví về tài khoản ngân hàng đã liên kết.'
                ]
            }
        ]
    },
    've-may-bay': {
        ...
        content: [
            {
                heading: 'Đặt vé máy bay',
                paragraphs: [
                    'Hiện tại Holidate chưa hỗ trợ đặt vé máy bay trực tiếp.',
                    'Tuy nhiên, chúng tôi đang phát triển tính năng này và sẽ sớm ra mắt trong tương lai.',
                    'Bạn có thể đặt khách sạn gần sân bay để tiện di chuyển.',
                    'Để được thông báo khi tính năng này ra mắt, vui lòng đăng ký nhận email từ chúng tôi.'
                ]
            }
        ]
    },
    ...
    've-xe-khach': {
        ...
        content: [
            {
                heading: 'Đặt vé xe khách',
                paragraphs: [
                    'Tính năng đặt vé xe khách đang được phát triển.',
                    'Trong thời gian chờ đợi, bạn có thể:',
                    '• Tìm khách sạn gần bến xe để tiện di chuyển',
                    '• Liên hệ trực tiếp với nhà xe qua thông tin trên website',
                    'Hãy theo dõi chúng tôi để cập nhật khi tính năng này ra mắt!'
                ]
            }
        ]
    },
    've-may-bay-khach-san': {
        ...
        content: [
            {
                heading: 'Combo du lịch',
                paragraphs: [
                    'Tính năng đặt combo vé máy bay + khách sạn đang được phát triển.',
                    'Khi tính năng này ra mắt, bạn sẽ có thể:',
                    '• Đặt vé máy bay và khách sạn cùng lúc với giá ưu đãi',
                    '• Tiết kiệm thời gian tìm kiếm',
                    '• Nhận nhiều ưu đãi độc quyền',
                    'Hãy đăng ký nhận thông báo để không bỏ lỡ ưu đãi đầu tiên!'
                ]
            }
        ]
    },
    'bao-hiem': {
        ...
        content: [
            {
                heading: 'Bảo hiểm khi đặt phòng',
                paragraphs: [
                    'Holidate cung cấp gói bảo hiểm du lịch tùy chọn khi đặt phòng:',
                    '• Bảo hiểm hủy chuyến: Hoàn tiền khi hủy vì lý do bất khả kháng',
                    '• Bảo hiểm tai nạn: Bảo vệ bạn trong suốt chuyến đi',
                    '• Bảo hiểm y tế: Chi trả chi phí y tế khi đi du lịch',
                    'Bạn có thể chọn mua bảo hiểm khi thanh toán đặt phòng.',
...
export default function HelpDetailPage() {
    ...
    const content = helpContent[slug];
            ...
            <div className={styles.helpPage}>
                <div className="container mt-5 mb-5">
                    <div className={styles.section}>
                        <h1 className={styles.sectionTitle}>Không tìm thấy trang</h1>
                        <p>Trang hỗ trợ bạn tìm kiếm không tồn tại.</p>
    ...
    return (
        <div className={styles.helpPage}>
            <div className="container mt-5 mb-5">
                <Link href="/help" className="text-decoration-none text-secondary mb-3 d-inline-block">
                    ← Quay lại Trung tâm Hỗ trợ
                </Link>
                ...
                <div className={styles.section}>
                    ...
                    {content.content.map((section, index) => (
                        <div key={index} className="mb-5">
                            <h2 className="h4 mb-3" style={{ color: '#0ea5e9', fontWeight: 600 }}>
                                {section.heading}
                            </h2>
