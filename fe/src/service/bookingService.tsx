...
//         } catch (error: any) {
//             const errorMessage = error.response?.data?.message || 'Không thể xem trước giá.';
//             throw new Error(errorMessage);
//         }
//     }
...
import apiClient, { ApiResponse } from './apiClient'; // Hoặc './api' tùy theo tên file của bạn
