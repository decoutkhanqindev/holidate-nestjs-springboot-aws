...
function BookingComponent() {
    ...
    // Tính toán giá - chỉ dùng priceDetails để đảm bảo tính chính xác
    ...
    // finalPrice luôn được lấy từ priceDetails để đảm bảo tính chính xác (bao gồm cả mã giảm giá)
                            ...
                            <div className={styles.priceDetailsContainer}>
                                <div className={styles.priceRow}>
                                    <div>
                                        ...
                                        <p style={{ margin: '4px 0 0 0', fontSize: '13px', color: '#666', fontWeight: 'normal' }}>
                                            {includesBreakfast ? '✔️ Đã bao gồm bữa sáng' : '❌ Không bao gồm bữa sáng'}
                                        </p>
                                    </div>
                    ...
                    <div className={styles.summaryCard}>
                        ...
                        <div className={styles.summaryPriceBox}>
                            ...
                            <div className={styles.priceValues}>
                                {isPriceLoading ? (
                                    <span className={styles.finalPrice} style={{ fontSize: '14px', color: '#666' }}>Đang tính toán...</span>
                                ) : !isLoggedIn ? (
                                    <span className={styles.finalPrice} style={{ fontSize: '14px', color: '#666' }}>Vui lòng đăng nhập</span>
                                    ...
                                    <span className={styles.finalPrice} style={{ fontSize: '14px', color: '#666' }}>Đang tải giá...</span>
                                )}
                            </div>
                        </div>
                    </div>
